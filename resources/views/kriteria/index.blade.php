...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">
                    <i class="fas fa-info-circle me-2"></i> Metode SMART
                </h5>
            </div>
            <div class="card-body">
                <p><strong>Simple Multi-Attribute Rating Technique (SMART)</strong> adalah metode untuk pengambilan keputusan dengan beberapa kriteria.</p>
                
                <h6>Langkah-langkah:</h6>
                <ol class="small">
                    <li>Identifikasi kriteria dan alternatif</li>
                    <li>Penentuan bobot kriteria</li>
                    <li>Normalisasi matriks keputusan</li>
                    <li>Perhitungan nilai utility</li>
                    <li>Penentuan nilai akhir</li>
                    <li>Pengurutan ranking</li>
                </ol>
                
                <h6>Rumus:</h6>
                <div class="bg-light p-2 rounded">
                    <small>Nilai Akhir = Σ (Utility × Bobot)</small><br>
                    <small>Utility = (Nilai / Nilai Maksimum) × 100</small>
                </div>
            </div>
        </div>
